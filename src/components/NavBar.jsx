...
function NavBar() {
    ...
    return (
        <header className="navbar">
            ...
            >
                <NavLink to="/" className="navbar__link" onClick={closeMenu}>Agenda</NavLink>
                ...
                <NavLink to="/" className="navbar__link" onClick={closeMenu}>Sponsors</NavLink>
                <NavLink to="/" className="navbar__link" onClick={closeMenu}>About</NavLink>
